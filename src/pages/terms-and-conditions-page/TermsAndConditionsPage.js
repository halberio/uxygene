...
const TermsAndConditionsPage = () => {
  return (
    <div className={"terms-and-conditons-page"}>
      <div className={"max-width-container"}>
        ...
        <p>
          ...
          <a href="https://uxygene.org">https://uxygene.org</a>
        </p>
        ...
        <p>uxygene uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          If you are located outside Tunisia and choose to provide information
          to us, please note that we transfer the data, including Personal Data,
          to Tunisia and process it there.
        </p>
        <p>
        ...
        <p>
          uxygene will take all steps reasonably necessary to ensure that your
        ...
        <p>
          uxygene may disclose your Personal Data in the good faith belief that
          such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of uxygene</li>
          <li>
        ...
        <ul>
          <li>
            By email:
            <a href="mailto:hello@uxygene.org">hello@uxygene.org</a>
          </li>
          <li>
            By visiting this page on our website:
            <Link to={"/get-in-touch"}> https://uxygene.org/get-in-touch</Link>
          </li>
        </ul>
      </div>
    </div>
